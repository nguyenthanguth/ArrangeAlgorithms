...
namespace ArrangeAlgorithms.UnitTest.Geometry
{
    public class CloneTests
    {
        ...
        {
            var original = new GeoPoint(3.5, -7.25);
        ...
        {
            var original = new GeoVector(3.0, 4.0);
            var clone = original.Clone();
        ...
        {
            var original = new GeoLine(new GeoPoint(1, 2), new GeoPoint(9, 14));
            var clone = original.Clone();
        ...
        {
            var original = new GeoCircle(new GeoPoint(2, -3), 7.5);
            var clone = original.Clone();
        ...
        {
            var original = new GeoRectangle(new GeoPoint(4, 5), 12.0, 3.5, Math.PI / 5.0);
            var clone = original.Clone();
        ...
        {
            var original = new GeoPolyline(new GeoPoint(0, 0), new GeoPoint(10, 0), new GeoPoint(10, 10));
            var clone = original.Clone();
        ...
        public void Clone_IsNotAffectedByAWiderGlobalTolerance()
        {
            ...
            var original = new GeoPolygon(
                new GeoPoint(0, 0), new GeoPoint(2, 0), new GeoPoint(2, 2), new GeoPoint(0, 2));
            var originalLine = new GeoPolyline(
                new GeoPoint(0, 0), new GeoPoint(2, 0), new GeoPoint(2, 2));
