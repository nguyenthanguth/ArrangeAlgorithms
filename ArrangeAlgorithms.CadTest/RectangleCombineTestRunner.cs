        ...
        public void RunRectangleCombineTest()
        {
            ...
            using (Transaction tr = db.TransactionManager.StartTransaction())
            {
                try
                {
                    ...
                    if (poly == null || !poly.TryToGeoRectangle(out GeoRectangle rect))
                    {
                    ...
                    GeoRectangle circleRect = geoCircle.ToRectangle(rect.AngleRad);

                    // Combine the two rectangles
                    GeoRectangle combined = rect.Combine(circleRect);
