...
namespace ArrangeAlgorithms.CadTest
{
    public class ClosestPointTestRunner
    {
        public void RunClosestPointTest()
        {
            ...
            GeoPoint pickedGeoPoint = pickedPoint3d.ToGeoPoint();
            ...
            using (Transaction tr = db.TransactionManager.StartTransaction())
            {
                try
                {
                    ...
                    GeoPoint closestGeoPoint = default(GeoPoint);
                    string objTypeStr = "";
                    ...
                    {
                        if (polyline.TryToGeoRectangle(out GeoRectangle geoRectangle))
                        {
                        ...
                        else if (polyline.Closed)
                        {
                            ...
                            GeoPolygon geoPolygon = polyline.ToGeoPolygon();
