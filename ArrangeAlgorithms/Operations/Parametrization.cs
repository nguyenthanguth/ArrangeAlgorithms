...
namespace ArrangeAlgorithms.Operations
{
    ...
    public static class Parametrization
    {
        ...
        public static double GetParameterAtPoint(GeoLine line, GeoPoint point)
        {
        ...
        public static double GetParameterAtPoint(GeoLine line, GeoPoint point, Tolerance tolerance)
        {
            GeoVector dir = line.Direction;
        ...
        /// </summary>
        public static GeoPoint GetPointAtParameter(GeoLine line, double parameter)
        {
        ...
        /// </summary>
        public static double GetDistanceAtParameter(GeoLine line, double parameter)
        {
        ...
        /// </summary>
        public static double GetParameterAtDistance(GeoLine line, double distance)
        {
        ...
        /// </summary>
        public static GeoPoint GetPointAtDistance(GeoLine line, double distance)
        {
        ...
        /// point.
        /// </summary>
        public static double GetDistanceAtPoint(GeoLine line, GeoPoint point)
        {
        ...
        /// </summary>
        public static GeoPoint GetPointAtParameter(GeoCircle circle, double parameter)
        {
        ...
        /// </summary>
        public static double GetParameterAtPoint(GeoCircle circle, GeoPoint point)
        {
        ...
        /// </summary>
        public static double GetDistanceAtParameter(GeoCircle circle, double parameter)
        {
        ...
        /// </summary>
        public static double GetParameterAtDistance(GeoCircle circle, double distance)
        {
        ...
        /// </summary>
        public static GeoPoint GetPointAtDistance(GeoCircle circle, double distance)
        {
        ...
        /// </summary>
        public static double GetDistanceAtPoint(GeoCircle circle, GeoPoint point)
        {
        ...
        /// </summary>
        public static GeoPoint GetPointAtParameter(GeoRectangle rect, double parameter)
        {
        ...
        /// point.
        /// </summary>
        public static double GetParameterAtPoint(GeoRectangle rect, GeoPoint point)
        {
        ...
        /// </summary>
        public static double GetDistanceAtParameter(GeoRectangle rect, double parameter)
        {
        ...
        /// </summary>
        public static double GetParameterAtDistance(GeoRectangle rect, double distance)
        {
            double length = rect.Length;
            return length <= 0.0 ? 0.0 : distance / length;
        }
        ...
        /// </summary>
        public static GeoPoint GetPointAtDistance(GeoRectangle rect, double distance)
        {
            double length = rect.Length;
        ...
        /// </summary>
        public static double GetDistanceAtPoint(GeoRectangle rect, GeoPoint point)
        {
        ...
        /// </summary>
        public static GeoPoint GetPointAtParameter(GeoPolygon poly, double parameter)
        {
        ...
        /// point.
        /// </summary>
        public static double GetParameterAtPoint(GeoPolygon poly, GeoPoint point)
        {
            double length = poly.Length;
        ...
        /// </summary>
        public static double GetDistanceAtParameter(GeoPolygon poly, double parameter)
        {
        ...
        /// </summary>
        public static double GetParameterAtDistance(GeoPolygon poly, double distance)
        {
            double length = poly.Length;
            return length <= 0.0 ? 0.0 : distance / length;
        }
        ...
        /// </summary>
        public static GeoPoint GetPointAtDistance(GeoPolygon poly, double distance)
        {
            double length = poly.Length;
        ...
        /// the supplied point.
        /// </summary>
        public static double GetDistanceAtPoint(GeoPolygon poly, GeoPoint point)
        {
        ...
        /// </summary>
        public static double GetParameterAtPoint(GeoPolyline polyline, GeoPoint point)
        {
            if (polyline == null) throw new ArgumentNullException(nameof(polyline));
        ...
        /// </summary>
        public static double GetDistanceAtParameter(GeoPolyline polyline, double parameter)
        {
            if (polyline == null) throw new ArgumentNullException(nameof(polyline));
        ...
        /// </summary>
        public static double GetParameterAtDistance(GeoPolyline polyline, double distance)
        {
            if (polyline == null) throw new ArgumentNullException(nameof(polyline));
        ...
        /// point.
        /// </summary>
        public static double GetDistanceAtPoint(GeoPolyline polyline, GeoPoint point)
        {
            if (polyline == null) throw new ArgumentNullException(nameof(polyline));
        ...
        /// </summary>
        private static GeoLine[] Edges(GeoPolygon poly)
        {
            if (poly == null) throw new ArgumentNullException(nameof(poly));

            GeoLine[] edges = new GeoLine[poly.EdgeCount];
        ...
        /// </summary>
        private static GeoLine[] Edges(GeoPolyline polyline)
        {
            GeoLine[] edges = new GeoLine[polyline.EdgeCount];
            for (int i = 0; i < edges.Length; i++)
            {
        ...
        private static GeoPoint PointAtDistance(GeoLine[] edges, double totalLength, double distance)
        {
            if (edges.Length == 0) return new GeoPoint();
        ...
        /// </summary>
        private static double DistanceAtPoint(GeoLine[] edges, GeoPoint point)
        {
            ...
            {
                GeoPoint projected = Projection.ProjectToLine(edge, point);
                double distanceSquared = Distance.GetDistanceSquaredTo(point, projected);
