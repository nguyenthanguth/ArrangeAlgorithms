...
namespace ArrangeAlgorithms.Core
{
    ...
    public static partial class Splition
    {
        ...
        public static bool TrySplitBy(GeoLine line, GeoPoint point, out GeoLine first, out GeoLine second)
        {
        ...
        /// </returns>
        public static bool TrySplitBy(GeoLine line, GeoPoint point, out GeoLine first, out GeoLine second, Tolerance tolerance)
        {
            first = default(GeoLine);
            second = default(GeoLine);
        ...
        /// <param name="second">The piece holding the end point of the segment.</param>
        /// <returns>true if the segment was split; otherwise, false.</returns>
        public static bool TrySplitAtDistance(GeoLine line, double distance, out GeoLine first, out GeoLine second)
        {
        ...
        /// of its endpoints.
        /// </returns>
        public static bool TrySplitAtDistance(GeoLine line, double distance, out GeoLine first, out GeoLine second, Tolerance tolerance)
        {
            first = default(GeoLine);
            second = default(GeoLine);
            ...
            GeoLine[] pieces = SplitLineAt(line, cuts);
            first = pieces[0];
            second = pieces[1];
            return true;
        }
        ...
        public static bool TrySplitBy(GeoPolyline polyline, GeoPoint point, out GeoPolyline first, out GeoPolyline second)
        {
        ...
        /// endpoints, where there is nothing to cut.
        /// </returns>
        public static bool TrySplitBy(GeoPolyline polyline, GeoPoint point, out GeoPolyline first, out GeoPolyline second, Tolerance tolerance)
        {
            first = null;
            second = null;
        ...
        /// <param name="second">The piece holding the end point of the polyline.</param>
        /// <returns>true if the polyline was split; otherwise, false.</returns>
        public static bool TrySplitAtDistance(GeoPolyline polyline, double distance, out GeoPolyline first, out GeoPolyline second)
        {
        ...
        /// of its endpoints.
        /// </returns>
        public static bool TrySplitAtDistance(GeoPolyline polyline, double distance, out GeoPolyline first, out GeoPolyline second, Tolerance tolerance)
        {
            first = null;
            second = null;
            ...
            GeoPolyline[] pieces = SplitPolylineAt(polyline, cuts, tolerance);
            if (pieces.Length != 2)
            {
                return false;
            }
        ...
        public static bool TrySplitBy(GeoLine subject, GeoLine cutter, out GeoLine first, out GeoLine second)
        {
        ...
        /// </returns>
        public static bool TrySplitBy(GeoLine subject, GeoLine cutter, out GeoLine first, out GeoLine second, Tolerance tolerance)
        {
            first = default(GeoLine);
            second = default(GeoLine);

            if (!Intersection.TryIntersectWith(subject, cutter, out GeoPoint crossing, tolerance))
            {
                return false;
            }
        ...
        public static bool TrySplitBy(GeoLine subject, GeoLine[] cutters, out GeoLine[] pieces)
        {
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the subject was split by at least one cutter; otherwise, false.</returns>
        public static bool TrySplitBy(GeoLine subject, GeoLine[] cutters, out GeoLine[] pieces, Tolerance tolerance)
        {
            if (cutters == null) throw new ArgumentNullException(nameof(cutters));

            var crossings = new List<GeoPoint>();
            foreach (GeoLine cutter in cutters)
            {
                if (cutter != null && Intersection.TryIntersectWith(subject, cutter, out GeoPoint crossing, tolerance))
                {
        ...
        public static bool TrySplitBy(GeoLine subject, GeoPolyline cutter, out GeoLine[] pieces)
        {
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the subject was split by the polyline; otherwise, false.</returns>
        public static bool TrySplitBy(GeoLine subject, GeoPolyline cutter, out GeoLine[] pieces, Tolerance tolerance)
        {
            if (cutter == null) throw new ArgumentNullException(nameof(cutter));

            int edgeCount = cutter.EdgeCount;
            GeoLine[] cutters = new GeoLine[edgeCount];
        ...
        /// <param name="pieces">The resulting pieces in order along the subject.</param>
        /// <returns>true if the subject was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoLine subject, GeoPoint[] points, out GeoLine[] pieces)
        {
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the subject was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoLine subject, GeoPoint[] points, out GeoLine[] pieces, Tolerance tolerance)
        {
        ...
        /// </summary>
        public static bool TrySplitBy(GeoLine subject, GeoPolygon[] cutters, out GeoLine[] inside, out GeoLine[] outside)
        {
        ...
        public static bool TrySplitBy(GeoLine subject, GeoPolygon[] cutters, out GeoLine[] inside, out GeoLine[] outside, Tolerance tolerance)
        {
            if (cutters == null) throw new ArgumentNullException(nameof(cutters));
            ...
            GeoLine[] pieces = SplitLineAt(subject, cuts);
        ...
        public static bool TrySplitBy(GeoLine subject, GeoPolyline[] cutters, out GeoLine[] pieces)
        {
            return TrySplitBy(subject, cutters, out pieces, Tolerance.Global);
        }
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if at least one polyline crosses the subject; otherwise, false.</returns>
        public static bool TrySplitBy(GeoLine subject, GeoPolyline[] cutters, out GeoLine[] pieces, Tolerance tolerance)
        {
            if (cutters == null) throw new ArgumentNullException(nameof(cutters));

            var edgeList = new List<GeoLine>();
            foreach (GeoPolyline polyline in cutters)
            {
                if (polyline != null)
                {
        ...
        /// <returns>true if the polyline was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoLine cutter, out GeoPolyline[] pieces)
        {
            return TrySplitBy(subject, cutter, out pieces, Tolerance.Global);
        }
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the polyline was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoLine cutter, out GeoPolyline[] pieces, Tolerance tolerance)
        {
        ...
        /// <param name="pieces">The resulting pieces in order along the subject.</param>
        /// <returns>true if the polyline was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoPoint[] points, out GeoPolyline[] pieces)
        {
            return TrySplitBy(subject, points, out pieces, Tolerance.Global);
        }
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the polyline was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoPoint[] points, out GeoPolyline[] pieces, Tolerance tolerance)
        {
            if (subject == null) throw new ArgumentNullException(nameof(subject));
            if (points == null) throw new ArgumentNullException(nameof(points));
        ...
        /// <param name="pieces">The resulting pieces in order along the subject.</param>
        /// <returns>true if the polyline was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoLine[] cutters, out GeoPolyline[] pieces)
        {
            return TrySplitBy(subject, cutters, out pieces, Tolerance.Global);
        }
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the polyline was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoLine[] cutters, out GeoPolyline[] pieces, Tolerance tolerance)
        {
            if (subject == null) throw new ArgumentNullException(nameof(subject));
            if (cutters == null) throw new ArgumentNullException(nameof(cutters));
            ...
            foreach (GeoLine cutter in cutters)
            {
                if (cutter != null)
                {
                    GeoPoint[] lineCrossings = Intersection.GetIntersections(subject, cutter, tolerance);
        ...
        /// <param name="pieces">The resulting pieces in order along the subject.</param>
        /// <returns>true if the polyline was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoPolyline[] cutters, out GeoPolyline[] pieces)
        {
            return TrySplitBy(subject, cutters, out pieces, Tolerance.Global);
        }
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the polyline was split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoPolyline[] cutters, out GeoPolyline[] pieces, Tolerance tolerance)
        {
            if (cutters == null) throw new ArgumentNullException(nameof(cutters));
        ...
        public static bool TrySplitBy(GeoPolyline subject, GeoPolygon[] cutters, out GeoPolyline[] inside, out GeoPolyline[] outside)
        {
            return TrySplitBy(subject, cutters, out inside, out outside, Tolerance.Global);
        }
        ...
        /// <param name="tolerance">The tolerance value to use for calculations.</param>
        /// <returns>True if the polyline is successfully split; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoPolygon[] cutters, out GeoPolyline[] inside, out GeoPolyline[] outside, Tolerance tolerance)
        {
            if (subject == null) throw new ArgumentNullException(nameof(subject));
            if (cutters == null) throw new ArgumentNullException(nameof(cutters));
            ...
            GeoPolyline[] pieces = SplitPolylineAt(subject, cuts, tolerance);
        ...
        public static bool TrySplitBy(GeoLine subject, GeoPolygon cutter, out GeoLine[] inside, out GeoLine[] outside)
        {
        ...
        /// <see cref="Containment.Contains(GeoPolygon, GeoPoint, Tolerance)"/>, which treats the boundary
        /// as part of the polygon.
        /// </remarks>
        public static bool TrySplitBy(GeoLine subject, GeoPolygon cutter, out GeoLine[] inside, out GeoLine[] outside, Tolerance tolerance)
        {
            if (cutter == null) throw new ArgumentNullException(nameof(cutter));

            GeoPoint[] crossings = Intersection.GetIntersections(cutter, subject, tolerance);
            double[] cuts = ToCutDistances(subject, crossings, tolerance);
            cuts = KeepCrossings(
                subject.Length, cuts,
                distance => Containment.Contains(cutter, Parametrization.GetPointAtDistance(subject, distance), tolerance),
                out bool[] insideOfPiece);

            GeoLine[] pieces = SplitLineAt(subject, cuts);

            var insideParts = new List<GeoLine>();
            var outsideParts = new List<GeoLine>();
        ...
        /// <returns>true if the polygon boundary crosses the subject; otherwise, false.</returns>
        public static bool TrySplitBy(GeoPolyline subject, GeoPolygon cutter, out GeoPolyline[] inside, out GeoPolyline[] outside)
        {
            return TrySplitBy(subject, cutter, out inside, out outside, Tolerance.Global);
        }
        ...
        /// <see cref="Containment.Contains(GeoPolygon, GeoPoint, Tolerance)"/>.
        /// </para>
        /// </remarks>
        public static bool TrySplitBy(GeoPolyline subject, GeoPolygon cutter, out GeoPolyline[] inside, out GeoPolyline[] outside, Tolerance tolerance)
        {
            if (subject == null) throw new ArgumentNullException(nameof(subject));
            if (cutter == null) throw new ArgumentNullException(nameof(cutter));
            ...
            var insideParts = new List<GeoPolyline>();
            var outsideParts = new List<GeoPolyline>();
        ...
        public static GeoLine[] SplitAtDistances(GeoLine line, IEnumerable<double> distances)
        {
        ...
        /// </returns>
        public static GeoLine[] SplitAtDistances(GeoLine line, IEnumerable<double> distances, Tolerance tolerance)
        {
        ...
        public static GeoPolyline[] SplitAtDistances(GeoPolyline polyline, IEnumerable<double> distances)
        {
        ...
        /// </returns>
        public static GeoPolyline[] SplitAtDistances(GeoPolyline polyline, IEnumerable<double> distances, Tolerance tolerance)
        {
            if (polyline == null) throw new ArgumentNullException(nameof(polyline));
