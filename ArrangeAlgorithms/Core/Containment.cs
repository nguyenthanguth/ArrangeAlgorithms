...
namespace ArrangeAlgorithms.Core
{
    ...
    public static class Containment
    {
        ...
        public static bool IsPointOn(GeoLine line, GeoPoint point)
        {
        ...
        public static bool IsPointOn(GeoLine line, GeoPoint point, Tolerance tolerance)
        {
            return Distance.DistanceTo(line, point) <= tolerance.EqualPoint;
        }
        ...
        public static bool IsPointOn(GeoCircle circle, GeoPoint point)
        {
        ...
        public static bool IsPointOn(GeoCircle circle, GeoPoint point, Tolerance tolerance)
        {
            return Math.Abs(Distance.DistanceTo(circle.Center, point) - circle.Radius) <= tolerance.EqualPoint;
        }
        ...
        public static bool IsPointOn(GeoPolygon poly, GeoPoint point)
        {
        ...
        public static bool IsPointOn(GeoPolygon poly, GeoPoint point, Tolerance tolerance)
        {
        ...
        public static bool IsPointOn(GeoPolyline polyline, GeoPoint point)
        {
        ...
        public static bool IsPointOn(GeoPolyline polyline, GeoPoint point, Tolerance tolerance)
        {
        ...
        public static bool Contains(GeoCircle circle, GeoPoint point, Tolerance tolerance)
        {
            return Distance.DistanceTo(circle.Center, point) <= circle.Radius + tolerance.EqualPoint;
        }

        /// <summary>
        /// Checks whether a rotated rectangle (GeoRectangle OBB) contains a point using default tolerance
        /// (accepts points on the boundary).
        /// </summary>
        /// <param name="rect">The rectangle.</param>
        /// <param name="point">The target point.</param>
        /// <returns>true if the rectangle contains the point; otherwise, false.</returns>
        public static bool Contains(GeoRectangle rect, GeoPoint point)
        {
            return Contains(rect, point, Tolerance.Global);
        }

        /// <summary>
        /// Checks whether a rotated rectangle (GeoRectangle OBB) contains a point within tolerance
        /// (accepts points on the boundary).
        /// </summary>
        /// <param name="rect">The rectangle.</param>
        /// <param name="point">The target point.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the rectangle contains the point; otherwise, false.</returns>
        public static bool Contains(GeoRectangle rect, GeoPoint point, Tolerance tolerance)
        {
        ...
        public static bool Contains(GeoPolygon poly, GeoPoint point)
        {
        ...
        public static PointLocation Locate(GeoCircle circle, GeoPoint point)
        {
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>PointLocation.Inside, PointLocation.OnSide, or PointLocation.OutSide.</returns>
        public static PointLocation Locate(GeoCircle circle, GeoPoint point, Tolerance tolerance)
        {
            double dist = Distance.DistanceTo(circle.Center, point);
        ...
        /// <summary>
        /// Classifies the spatial location of a point relative to a rotated rectangle (GeoRectangle OBB) using default tolerance.
        /// </summary>
        /// <param name="rect">The rectangle.</param>
        /// <param name="point">The target point.</param>
        /// <returns>PointLocation.Inside, PointLocation.OnSide, or PointLocation.OutSide.</returns>
        public static PointLocation Locate(GeoRectangle rect, GeoPoint point)
        {
            return Locate(rect, point, Tolerance.Global);
        }

        /// <summary>
        /// Classifies the spatial location of a point relative to a rotated rectangle (GeoRectangle OBB) within tolerance.
        /// </summary>
        /// <param name="rect">The rectangle.</param>
        /// <param name="point">The target point.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>PointLocation.Inside, PointLocation.OnSide, or PointLocation.OutSide.</returns>
        public static PointLocation Locate(GeoRectangle rect, GeoPoint point, Tolerance tolerance)
        {
            double dx = point.X - rect.Center.X;
            double dy = point.Y - rect.Center.Y;
        ...
        /// <param name="point">The target point.</param>
        /// <returns>PointLocation.Inside, PointLocation.OnSide, or PointLocation.OutSide.</returns>
        public static PointLocation Locate(GeoPolygon poly, GeoPoint point)
        {
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>PointLocation.Inside, PointLocation.OnSide, or PointLocation.OutSide.</returns>
        public static PointLocation Locate(GeoPolygon poly, GeoPoint point, Tolerance tolerance)
        {
            if (poly == null) throw new ArgumentNullException(nameof(poly));
        ...
        /// <param name="point">The target point.</param>
        /// <returns>PointLocation.Inside, PointLocation.OnSide, or PointLocation.OutSide.</returns>
        public static PointLocation Locate(GeoPolyline polyline, GeoPoint point)
        {
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>PointLocation.Inside, PointLocation.OnSide, or PointLocation.OutSide.</returns>
        public static PointLocation Locate(GeoPolyline polyline, GeoPoint point, Tolerance tolerance)
        {
            if (polyline == null) throw new ArgumentNullException(nameof(polyline));
        ...
        public static PointLocation Locate(GeoLine line, GeoPoint point)
        {
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>PointLocation.OnSide if on the line segment; otherwise PointLocation.OutSide.</returns>
        public static PointLocation Locate(GeoLine line, GeoPoint point, Tolerance tolerance)
        {
        ...
        /// </summary>
        public static bool Contains(GeoRectangle rect, GeoLine line)
        {
        ...
        /// </summary>
        public static bool Contains(GeoRectangle rect, GeoLine line, Tolerance tolerance)
        {
        ...
        /// </summary>
        public static bool Contains(GeoRectangle rect, GeoPolyline polyline)
        {
        ...
        /// </summary>
        public static bool Contains(GeoRectangle rect, GeoPolyline polyline, Tolerance tolerance)
        {
            if (polyline == null) throw new ArgumentNullException(nameof(polyline));
            for (int i = 0; i < polyline.EdgeCount; i++)
            {
        ...
        public static bool Contains(GeoCircle circle, GeoCircle other)
        {
        ...
        public static bool Contains(GeoCircle circle, GeoCircle other, Tolerance tolerance)
        {
            return Distance.DistanceTo(circle.Center, other.Center) + other.Radius <= circle.Radius + tolerance.EqualPoint;
        }

        /// <summary>
        /// Checks whether a circle entirely contains a line segment using default tolerance.
        /// </summary>
        public static bool Contains(GeoCircle circle, GeoLine line)
        {
        ...
        /// </summary>
        public static bool Contains(GeoCircle circle, GeoLine line, Tolerance tolerance)
        {
        ...
        public static bool Contains(GeoPolygon poly, GeoLine line)
        {
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the polygon entirely contains the line segment; otherwise, false.</returns>
        public static bool Contains(GeoPolygon poly, GeoLine line, Tolerance tolerance)
        {
            if (poly == null) throw new ArgumentNullException(nameof(poly));
            ...
            for (int i = 0; i < poly.EdgeCount; i++)
            {
                if (Intersection.TryIntersectWith(line, poly.GetEdgeAt(i), out GeoPoint crossing, tolerance))
                {
                    parameters.Add(Parametrization.GetParameterAtPoint(line, crossing));
                }
            }
        ...
        public static bool Contains(GeoPolygon poly, GeoPolyline polyline)
        {
        ...
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the polygon entirely contains the polyline; otherwise, false.</returns>
        public static bool Contains(GeoPolygon poly, GeoPolyline polyline, Tolerance tolerance)
        {
            if (poly == null) throw new ArgumentNullException(nameof(poly));
            if (polyline == null) throw new ArgumentNullException(nameof(polyline));
